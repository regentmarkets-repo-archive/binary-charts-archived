...
const defaultItems = [
    ...
    { text: 'Exponential Moving Average (EMA)', value: 'ema', img: uncheckedIcon, checked: false },
    ...
    { text: 'Moving Average Convergence Divergence (MACD)', value: 'macd', img: uncheckedIcon, checked: false },
];
